...
const MENU_ITEMS = [
  ...
  {
    name: "Beef Mushroom Oyster Sauce",
    nickName: ["vg"],
    price: 13.95,
    category: "Chef Suggestions",
    quantity: 1,
